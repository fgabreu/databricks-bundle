...
def test_get_trip_duration_mins():
    ...
    schema = "start_time timestamp timestamp, end_timestamp timestamp"
    df = spark.createDataFrame(data, schema=schema)

    # Apply the function to compute trip duration in minutes
    result_df = get_trip_duration_mins(spark, df, "start_timestmap", "end_timestamp", "trip_duration_mins")
